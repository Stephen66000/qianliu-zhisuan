#!/usr/bin/env bash
# Combined operating analysis, historical attribution and zero-fee fixes. No migration, no dependency or topology changes.
set -Eeuo pipefail
...
GIT_SSH_COMMAND='ssh -o BatchMode=yes' GIT_TERMINAL_PROMPT=0 \
  git -C "$release" fetch --depth 16 origin "$candidate"
...
while IFS= read -r changed; do
  case "$changed" in
    deploy/scripts/release-operating-three-fixes-20260907-mac-mini.sh|V4/Evidence/OPERATING-BILL-20260906/PARTIAL-USAGE-FIX.md|V4/Evidence/OPERATING-BILL-20260906/RELEASE-PREP.md|V4/Evidence/OPERATING-BILL-20260906/THREE-FIXES-READY.md|V4/Evidence/OPERATING-BILL-20260906/ZERO-SUBSCRIPTION-FIX.md|apps/control-api/src/__tests-integration__/pool043-operating-bill-accounts.test.ts|apps/control-api/src/principals/accounting-route.ts|apps/control-api/src/principals/attribution-backfill-route.ts|apps/web/src/api/operating-analysis.ts|apps/web/src/components/operating-bill/OperatingAnalysisPartial.test.tsx|apps/web/src/components/operating-bill/OperatingPlans.tsx|apps/web/src/components/operating-bill/OperatingProcurement.tsx|apps/web/src/components/operating-bill/OperatingTrends.tsx|apps/web/src/components/principals/HistoricalAttributionPanel.test.tsx|apps/web/src/components/principals/HistoricalAttributionPanel.tsx|apps/web/src/components/principals/PrincipalAccountingPanel.tsx|apps/web/src/pages/OperatingBill.tsx|apps/web/src/pages/OperatingBillDepartments.tsx|apps/web/src/pages/OperatingBillOverview.tsx|deploy/scripts/release-operating-bill-20260907-mac-mini.sh|deploy/scripts/release-operating-partial-20260907-mac-mini.sh|packages/database/src/__tests-integration__/operating-analysis.integration.test.ts|packages/database/src/__tests-integration__/pool043-operating-bill-accounts.integration.test.ts|packages/database/src/__tests-integration__/principal-attribution-backfill.integration.test.ts|packages/database/src/index.ts|packages/database/src/repositories/operating-analysis-repository.ts|packages/database/src/repositories/operating-analysis-usage.ts|packages/database/src/repositories/operating-bill-account-month-lines.ts|packages/database/src/repositories/principal-accounting.ts|packages/database/src/repositories/principal-attribution-backfill.ts|packages/database/src/repositories/usage-aggregate-repository.ts) ;;
