#!/usr/bin/env bash
# Resource model visibility update on the deployed model lifecycle base; no migration.
set -Eeuo pipefail
umask 077
...
source_commit=28f6a603c29986b56985f9e305a82cb6c51a9253
root=/Users/stephen
...
GIT_SSH_COMMAND='ssh -o BatchMode=yes' GIT_TERMINAL_PROMPT=0 git clone --depth 8 \
  --branch codex/resource-model-visibility-20260910 git@github.com:Stephen66000/qianliu-zhisuan.git "$release"
