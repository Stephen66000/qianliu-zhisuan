#!/usr/bin/env bash
# WeCom reporting engine and incentive cards release on production Mac mini.
...
release="$root/releases/qianliu-wecom-reporting-$stamp"
backup_image="qianliu-wecom-reporting-rollback-$stamp"
...
exec > >(tee -a "$root/logs/qianliu-zhisuan/deploy-wecom-reporting-$stamp.log") 2>&1

echo "=========================================="
echo "开始部署: 仟流智算企业微信报表引擎 (分支: $branch)"
echo "时间: $stamp"
echo "=========================================="
