#!/usr/bin/env bash
# Finance entry, subscription options, API cost and monthly token repair. No schema or dependency changes.
set -Eeuo pipefail
...
mode="${1:-deploy}"
case "$mode" in deploy|--preflight) ;; *) echo 'Usage: bash release-finance-entry-20260907-mac-mini.sh [--preflight|--check-contract]'; exit 2;; esac
test "$#" -le 1
candidate=de0a2ec3b7446ab3e0b6d81344d7d84ac2163eab
tree=8a467b9a21b200787a2b0af026aed320cbe83acf
expected_source=db78a30ef8b6989887baf7cdc1637d3378e8f89e
...
release="$root/releases/qianliu-finance-entry-de0a2ec-$stamp"
backup="$root/backups/qianliu-zhisuan/pre-finance-entry-de0a2ec-$stamp.dump"
rollback_prefix="qianliu-finance-entry-de0a2ec-rollback-$stamp"
log="$root/logs/qianliu-zhisuan/deploy-finance-entry-de0a2ec-$stamp.log"
started=0
frozen=0
pointer_changed=0
success=0
...
expected_paths_sha256=60ff511e151c0dd2b7921152d983fbeb39804e0189c5b71531a4a1b6ced753d1
