#!/usr/bin/env bash
# Unified operating-bill and POOL20-053/054 release. No migration, dependency or topology changes.
set -Eeuo pipefail
...
mode="${1:-deploy}"
case "$mode" in deploy|--preflight) ;; *) echo 'Usage: bash release-combined-20260907-mac-mini.sh [--preflight|--check-contract]'; exit 2;; esac
test "$#" -le 1
candidate=2b90de19d3d58b175599449613ce31f5b59d3638
tree=080985e7c8a68f9f9eabdbd36c99b81ec5dc8723
...
release="$root/releases/qianliu-combined-2b90de1-$stamp"
backup="$root/backups/qianliu-zhisuan/pre-combined-2b90de1-$stamp.dump"
rollback_prefix="qianliu-combined-2b90de1-rollback-$stamp"
log="$root/logs/qianliu-zhisuan/deploy-combined-2b90de1-$stamp.log"
started=0
frozen=0
pointer_changed=0
success=0
...
expected_paths_sha256=433c7052c7cdc7cda94ea83f8c566ddc4e7a09a9e889c7de3d544af2d945bed7
