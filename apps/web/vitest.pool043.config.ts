...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      "src/pages/OperatingBillRechargeEntry.test.tsx",
    ...
    coverage: {
      ...
      include: [
        ...
        "src/pages/OperatingBillRechargeEntry.tsx",
        "src/pages/OperatingBillShared.tsx",
        "src/pages/Dashboard.tsx",
        "src/components/usage/UsageSubjectPicker.tsx",
        "src/components/usage/UsageOverviewPanel.tsx",
        "src/lib/currency.ts",
