...
import { seedE2eCatalog } from "./seed-e2e-catalog.js";
import { seedE2eOperations } from "./seed-e2e-operations.js";
...
async function main(): Promise<void> {
  ...
  try {
    ...
    await seedE2eCatalog(db, passwordHash);
    await db
    ...
    await db
      ...
      .execute();
    await seedE2eOperations(db, now);
