...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 540 800" width="540" height="800">
  <defs>
    <filter id="over50CardShadow" x="-10%" y="-10%" width="130%" height="130%">
  ...
  <rect x="40" y="50" width="460" height="700" rx="18" fill="#FFFFFF" stroke="#E2E8F0" stroke-width="1" filter="url(#over50CardShadow)"/>
