...
// ===== PF-INIT/WP01：资金账本初始化（规范化、周期语义、候选哈希、守恒摘要）=====
export {
  ...
  ACTIVATION_CANDIDATE_TRANSITIONS,
  USAGE_REPAIR_FIELDS,
  ...
  type ActivationResourceMode,
  type ActivationDraft,
  type OpeningBalanceDraftItem,
  type HistoricalRechargeDraftItem,
  type CodingPlanPurchaseDraftItem,
  type CodingPlanCarryoverDraftItem,
  type LegacyPurchaseResolutionDraftItem,
  type LegacyPurchaseResolutionKind,
  ...
  type ActivationCandidateHashInput,
  type ResourceFinanceState,
  type QuiescenceLeaseView,
  type QuiescenceEvaluation,
} from "./provider-finance-activation.js";

// ===== PF-INIT/WP02：余额聚合语义（唯一公式）与候选假设投影 =====
export {
  Money,
  money,
  BALANCE_COMPONENT_KEYS,
  BALANCE_POSITIVE_COMPONENT_KEYS,
  BALANCE_NEGATIVE_COMPONENT_KEYS,
  emptyBalanceComponents,
  normalizeBalanceComponents,
  sumBalanceComponents,
  balanceAmount,
  addBalanceComponents,
  isBalanceNegative,
  balanceFormulaMatches,
  type BalanceComponentKey,
...
} from "./provider-finance-activation-projection.js";
