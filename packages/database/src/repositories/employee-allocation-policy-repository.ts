...
export async function rulesOfPolicies(db: AllocationDb, policyIds: string[]): Promise<AllocationRuleRow[]> {
...
export async function accountingByProject(
  db: AllocationDb,
  enterpriseId: string,
  projectIds: string[],
...
export function toDomainRule(rule: DesiredRuleInput): PolicyRuleInput {
  return {
